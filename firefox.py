...
driver_path = 'C://Users//anaray01//Downloads//geckodriver//geckodriver.exe'
    ...
    try:
        ...
        for job_elem in job_elems:
            ...
            if target_dict is None:
                with open(f"error_firefox_{i}_{iteration}", "w+") as fp:
                    fp.write(results)
            else:
                pass
        ...
        driver.save_screenshot(driver.current_url[-1::] + "_firefox.png")
        sleep(10)
    except ValueError:
        print("Value Error")
...
col_list = columns = ['Title', 'Company', 'Location', 'Experience', 'Salary', 'Skills', 'URL', 'Job_Post_History',
                      'Page']
pd.DataFrame(df_list, columns=col_list).to_csv('result_Firefox.csv', index=False)
